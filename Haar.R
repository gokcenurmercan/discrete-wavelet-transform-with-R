#burada sadece z de d,n+ö+m zaptin x ler orjänal data 
#soft default
...
plot(sicaklikwr1,type = "l", xlab = "Günler", las=1, ylab="Sicaklik (wr)")
...
plot(ruzgarhwr1,type = "l", xlab = "Günler", las=1, ylab = "Rüzgar hizi (wr)")
#
