library("wavethresh")
datasicaklikwd1 = wd(datasicaklik, filter.number = 10, family = "DaubLeAsymm")
dataruzgarhwd1 = wd(dataruzgarh, filter.number = 10, family= "DaubLeAsymm")
datanemwd1 = wd(datanem, filter.number = 10, family = "DaubLeAsymm")
databasincwd1 = wd(databasinc,filter.number = 10, family = "DaubLeAsymm")
...
ruzgarhwdT1 = threshold(dataruzgarhwd1, policy = "manual",value = uthresholdr)
...
nemwdT1 = threshold(datanemwd1, policy = "manual",value = uthresholdnem)
nemwr1 = wr(nemwdT1)
...
basincwdT1 = threshold(databasincwd1, policy = "manual",value = uthresholdb)
