library("wavethresh")
datasicaklikwd1 = wd(datasicaklik, filter.number = 4, family = "DaubLeAsymm")
dataruzgarhwd1 = wd(dataruzgarh, filter.number = 4, family= "DaubLeAsymm")
datanemwd1 = wd(datanem, filter.number = 4, family = "DaubLeAsymm")
databasincwd1 = wd(databasinc,filter.number = 4, family = "DaubLeAsymm")
